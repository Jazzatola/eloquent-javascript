...
// has position 0, which causes the last one to be found at position
// string.length - 1. In other words, a two-character string has length 2, and
...
const countChar = (w, m) =>
  w.split("").reduce((acc, c) => (c === m ? acc + 1 : acc), 0);
